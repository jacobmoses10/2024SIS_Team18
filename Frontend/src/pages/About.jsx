    ...
    <div className="container mx-auto px-4">
      <div className="text-center">
        ...
        <p className="text-lg mb-4">
          ...
          looking to enhance their brainstorming, note-taking, and artistic skills.
        </p>
        <p className="text-lg mb-4">
          Utilizing advanced AI technology, our whiteboard facilitates real-time 
          idea generation, diagramming, and problem-solving. Users can draw, type, 
          and instantly convert their thoughts into organized digital notes.
        </p>
        <p className="text-lg mb-4">
          ...
          team brainstorming new ideas, Whiteboard AI is the tool you need to bring 
          your ideas to life.
        </p>
        ...
        <ul className="list-disc list-inside mb-6">
          ...
          <li>AI-enhanced features to help organize and optimize your ideas.</li>
        ...
        <p className="text-lg mb-4">
          Our team is made up of passionate engineers, designers, and thinkers dedicated 
          to improving the way people communicate and create together. We're constantly 
          working to refine and expand the capabilities of Whiteboard AI to meet the needs 
