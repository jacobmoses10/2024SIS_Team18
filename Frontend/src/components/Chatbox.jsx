...
const Chatbox = ({ messages, onSendMessage, topic, setBotModal }) => {
  ...
  return (
    <div className="p-4">
      <div className="w-min mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
        <div className="bg-white text-black h-10 flex items-center px-4 p-6">
