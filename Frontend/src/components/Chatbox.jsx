...
const Chatbox = ({ messages, onSendMessage, topic, chatVisible, toggleChatVisibility, setBotModal }) => {
  ...
  const getBadgeStyle = () => {
    ...
    if (topic === "Economics") return `bg-yellow-100 text-yellow-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded cursor-pointer`;
    if (topic === "Music Thoery") return `bg-yellow-100 text-yellow-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded cursor-pointer`;
    if (topic === "Visual Art") return `bg-yellow-100 text-yellow-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded cursor-pointer`;
